...
namespace Pico.Platform.Models
{
    public class KVPairArray
    {
        ...
        {
            Size = size;
            Handle = CLIB.ppf_KeyValuePairArray_Create(size);
        }
        ...
        {
            return new KVPair(CLIB.ppf_KeyValuePairArray_GetElement(Handle, index));
        }
    }
    ...
    public class KVPair
    {
        ...
        {
            return Marshal.PtrToStringAuto(CLIB.ppf_KeyValuePair_GetStringValue(Handle));
        }
        ...
        {
            return Marshal.PtrToStringAuto(CLIB.ppf_KeyValuePair_GetKey(Handle));
        }
