...
namespace Pico.Platform.Models
{
    ...
    public class MatchmakingAdminSnapshotCandidateList : MessageArray<MatchmakingAdminSnapshotCandidate>
    {
        ...
        {
            var count = CLIB.ppf_MatchmakingAdminSnapshotCandidateArray_GetSize(a);
            this.Capacity = count;
            for (int i = 0; i < count; i++)
            {
                this.Add(new MatchmakingAdminSnapshotCandidate(CLIB.ppf_MatchmakingAdminSnapshotCandidateArray_GetElement(a, Convert.ToUInt32(i))));
            }
        }
    }
    ...
    public class MatchmakingEnqueueResult
    {
        ...
        public MatchmakingEnqueueResult(IntPtr o)
        {
            ...
            Pool = CLIB.ppf_MatchmakingEnqueueResult_GetPool_String(o);
    ...
    public class MatchmakingRoomList : MessageArray<MatchmakingRoom>
    {
        ...
        {
            int count = CLIB.ppf_MatchmakingRoomArray_GetSize(a);
            this.Capacity = count;
            for (uint i = 0; i < count; i++)
            {
                this.Add(new MatchmakingRoom(CLIB.ppf_MatchmakingRoomArray_GetElement(a, i)));
            }
        }
    }
